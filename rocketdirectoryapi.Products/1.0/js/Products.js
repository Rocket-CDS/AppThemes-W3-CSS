function products_showSelectedMonths(monthidx, date1, date2, reloadUrl, browserUrl, cscSelectedClass) {
...
function products_clearFiltersCategories(cscSelectedClass) {
    $('.simplisity_loader').show();
...
function products_pageLoad(cscSelectedClass) {
    $('.simplisity_loader').show();
