function propertyagent_showSelectedMonths(monthidx, date1, date2, reloadUrl, browserUrl, cssSelectedClass) {
...
function propertyagent_clearFiltersCategories(cssSelectedClass) {
    $('.simplisity_loader').show();
...
function propertyagent_pageLoad(cssSelectedClass) {
    $('.simplisity_loader').show();
...
function propertyagent_sharrre(pageUrl, iconClass) {
